...
public class MemPhysicalDto {
    ...
    public MemPhysical toEntity(MemPhysicalDto memPhysicalDto) {
        return MemPhysical.builder()
                .memPhysical(memPhysicalDto.getMemPhysical())
